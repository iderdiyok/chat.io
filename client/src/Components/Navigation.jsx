...
const Navigation = (props) => {
    ...
    const clickHandler = () => {
        props.setShowConversations(current => !current)
      }
    return (
        <nav className="col-2 navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
            ...
            <ul className="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
                <li className="nav-item">
                    <div className={!props.showConversations ? 'nav-link active py-0 py-lg-8' : 'nav-link py-0 py-lg-8'} id="tab-friends" onClick={clickHandler}>
                ...
                <li className="nav-item">
                    <div className={props.showConversations ? 'nav-link active py-0 py-lg-8' : 'nav-link py-0 py-lg-8'} id="tab-chats" onClick={clickHandler}>
                        <div className="icon icon-xl">
                ...
                <li className="nav-item">
                    <div className="nav-link py-0 py-lg-8" id="tab-settings">
                        <div className="icon icon-xl">
                ...
                <li className="nav-item d-none d-xl-block">
                    <div className="nav-link p-0 mt-lg-2" >
                        <div className="avatar mx-auto">
                            <img className="avatar-img" src={props.user?.avatar} alt=""/>
                        </div>
                    </div>
                </li>
            </ul>
